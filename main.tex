...
\section{Skills}
\resumeSubItem{\textbf{Technologies}}
{: (proficient) Python, SQL, Typescript, Javascript, git, Docker, unix (familiar) C, C++, Java, C\#}
\resumeSubHeadingListEnd
...
\section{Skills}
\resumeSubItem{\textbf{Technologies}}
{: (proficient) Python, SQL, Typescript, Javascript, HTML/CSS, git, Docker, unix (familiar) C, C++, Java, C\#, R}
\resumeSubHeadingListEnd
